...
Source0  : https://downloads.videolan.org/pub/videolan/dav1d/1.4.1/dav1d-1.4.1.tar.xz
Source1  : https://downloads.videolan.org/pub/videolan/dav1d/1.4.1/dav1d-1.4.1.tar.xz.asc
...
%prep
%setup -q -n dav1d-1.4.1
cd %{_builddir}/dav1d-1.4.1
pushd ..
cp -a dav1d-1.4.1 buildavx2
popd
pushd ..
cp -a dav1d-1.4.1 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710534572
