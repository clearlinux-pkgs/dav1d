...
Version  : 1.5.0
Release  : 34
URL      : https://downloads.videolan.org/pub/videolan/dav1d/1.5.0/dav1d-1.5.0.tar.xz
Source0  : https://downloads.videolan.org/pub/videolan/dav1d/1.5.0/dav1d-1.5.0.tar.xz
Source1  : https://downloads.videolan.org/pub/videolan/dav1d/1.5.0/dav1d-1.5.0.tar.xz.asc
...
%setup -q -n dav1d-1.5.0
cd %{_builddir}/dav1d-1.5.0
pushd ..
cp -a dav1d-1.5.0 buildavx2
popd
pushd ..
cp -a dav1d-1.5.0 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729528703
