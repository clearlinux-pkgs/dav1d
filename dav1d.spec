...
Source0  : https://downloads.videolan.org/pub/videolan/dav1d/1.4.2/dav1d-1.4.2.tar.xz
Source1  : https://downloads.videolan.org/pub/videolan/dav1d/1.4.2/dav1d-1.4.2.tar.xz.asc
...
%setup -q -n dav1d-1.4.2
cd %{_builddir}/dav1d-1.4.2
pushd ..
cp -a dav1d-1.4.2 buildavx2
popd
pushd ..
cp -a dav1d-1.4.2 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716741290
